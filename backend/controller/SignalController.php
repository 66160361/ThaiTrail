...
class SignalController
{
    ...
    public function store(array $params, array $body): array
    {
        ...
        try {
            ...
            $ins->execute([$userId, $placeId, $targetSignalType, $platform, $durationSeconds]);

            if ($targetSignalType === 'view') {
                $this->upsertUserInteraction($userId, $placeId, null, null, null, 0, 1);
            }
            if ($targetSignalType === 'share') {
